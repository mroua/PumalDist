"""
Django settings for PumaDist project.
...
SECRET_KEY = 'django-insecure-(#cutk3r(rxa&qr4g^fof_!20=zjf@w3i$hwz3&wfh1nf0plwv'
...
INSTALLED_APPS = [
    ...
    'Distributeur.apps.DistributeurConfig',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                 'mes_tags': 'PumaDist.templatetags.mes_tags',
...
WSGI_APPLICATION = 'PumaDist.wsgi.application'
