    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(blank=True, choices=[('Est', 'Est'), ('Ouest', 'Ouest'), ('Centre', 'Centre')], default='EST', max_length=6, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('type', models.CharField(choices=[('Admin', 'Admin'), ('Agent', 'Agent'), ('Admin Régional', 'Admin Régional'), ('Admin Wilaya', 'Admin Wilaya'), ('Résponsable distributeur', 'Résponsable distributeur'), ('Distributeur', 'Distributeur'), ('Employé', 'Employé')], default='Agent', max_length=32)),
                ('region', models.CharField(blank=True, choices=[('Est', 'Est'), ('Ouest', 'Ouest'), ('Centre', 'Centre')], default='EST', max_length=6, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ville', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Session.ville')),
            ],
        ),
    ]
